<?php $this->set('navbarArray',array(array('Configuration','index','Configs'),array('Schemes','uploadScheme','Configs'),array('Mapping')));
...
echo $this->Html->image("save.png",array(
    'id' => 'saveButton',
    'data-url' => Router::url(array('controller'=>'Configs','action'=>'saveIndexMapping'),true),
    'border' => "0",
    'width'=>'15px',
    'class' => 'clickable button',
    'style'=>'margin:5px; float:left;',
    'onclick'=>'saveMapping("'.$scheme.'")',
    'title' => 'save mapping (Ctrl+S)',
    "alt" => "save"
));
...
echo $this->Html->image("trash.ico",array(
    'id' => 'trashButton',
    'data-url'=>Router::url(array('controller'=>'Configs','action'=>'deleteIndexMapping'),true),
    "border" => "0",
    'width'=>'15px',
    'class' => 'clickable button',
    'style'=>'margin:5px; float:left;',
...
echo $this->Html->image("upload.ico",array(
    'id' => 'uploadButton',
    'data-url'=>Router::url(array('controller'=>'Configs','action'=>'reindexScheme'),true),
    "border" => "0",
    'width'=>'15px',
    'class' => 'clickable button',
    'style'=>'margin:5px; float:left;',
    'onclick'=>'putIndexMapping("'.$scheme.'")',
    'title' => 'upload mapping version & reindex',
    "alt" => "reindex"
));
/*
...
*/
echo '<div style="float:left;" id="msg"></div>';

//Version selection
echo '<button  data-url="'.Router::url(array('controller'=>'XMLObjects','action'=>'loadIndexMapping'),true).'" style="float:right;clear:none;margin-top:6px;" type="button" onclick="loadMappingSelectedVersion(\''.$scheme.'\')" >load</button>';
...
echo '<div id="editor" data-url="'.Router::url(array('controller'=>'Configs','action'=>'loadIndexMapping'),true).'" style="position:relative;height:600px;clear:both"></div>';
?>
