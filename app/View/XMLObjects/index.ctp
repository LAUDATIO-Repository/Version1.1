...
<br><div id="box1" style="padding:0px;border:0px solid black;">Welcome to the LAUDATIO-Repository!
    This is the first release of the repository which is still work in progress. Please contact us if you have any questions, feature requests, or bug reports.
...
<div id="accordion">
<h2><a href="#">LAUDATIO-Repository</a></h2>
<div>
...
The project is funded by the German Research Foundation from 2011-2018. The departments of Corpus Linguistics
...
<ul>
    <li>display corpora,</li>
    <li>search corpora,</li>
    <li>download corpora,</li>
...
<div>
    ...
    <p>Research data in historical corpus linguistics consists of digitized text material, transcriptions of historical texts and linguistic annotation
        ...
        over a long period. For this academic discipline, it would be a big advantage if such corpora - prepared in one way or another - are accessible and (re-)usable for all corpus linguists dealing with similar historical language data.
    </p>
</div>
...
<div>
    ...
    <p>A detailed and full documentation of the preparation and annotation process including a bibliographic list of the digitized texts
        ...
        add annotations or new texts to already existing corpora, or in order to use them as a template for practicing in building a new corpus.
...
<?php
    $link = $this->Html->link('here',array('plugin' => null, 'admin' => false, 'action' => '../laudatio'), array('target'=>'_blank','escape'=>false));
    echo '<br><div>More information about the project can be found '.$link.'</a>.</div>'
?>
</div>
</body>
</html>