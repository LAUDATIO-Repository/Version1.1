...
<div id="accordion">
    ...
    <h2><a href="#">Data Curation and Acquisition</a></h2>
    <div>
        <table>
            <tr>
                <td>
    ...
    <h2><a href="#">Development LAUDATIO-Repository</a></h2>
    <div>
        <table>
            <tr>
                <td>
    ...
    <h2><a href="#">Development search- and visualization system ANNIS</a></h2>
    <div>
        <table>
            <tr>
                <td>
