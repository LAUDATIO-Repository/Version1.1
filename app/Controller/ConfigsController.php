    ...
    public function index(){
        if(isset($_POST) && !empty($_POST)){
            if(ctype_alnum($_POST['indexName'])){
                ...
                Configure::dump('site_config_dev.php', 'default',array('IndexConfig','SchemeConfig'));
    ...
    public function uploadScheme(){
        if(isset($_POST) && !empty($_POST) ){
            if(isset($_POST['delete'])){
                ...
                Configure::dump('site_config_dev.php', 'default',array('IndexConfig','SchemeConfig','FedoraConfig','PiwikConfig','HandleConfig'));
