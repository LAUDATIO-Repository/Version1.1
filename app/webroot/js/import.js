/**
 * Created by DZielke on 21.07.14.
 */
...
function loadContent(){
    ...
    $.ajax({
        ...
        success:function(data,textStatus,jqXHR){
            ...
            descriptionElement.append('<form method="post" action="import" id="contentForm"><input type="hidden" name="file" value="'+file+'"><textarea style="width:100%;min-height:300px;" name="content" id="editContent">'+data+'</textarea></form>');
